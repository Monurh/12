...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var copy = car.DeepCopy();
            var carImages = CopyCar(copy);
        }
        ...
        private Image CopyCar(Car copy )
        {
            if (copy.Color == "black")
            {
                return pictureBox2.Image = Resource1.blackcar;
            }
            else
            {
                return pictureBox2.Image = Resource1.whitecar;
            }
        }
    }     
}
